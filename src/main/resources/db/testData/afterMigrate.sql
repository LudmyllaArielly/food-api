...
insert into restaurant (address_zip_code, address_public_place, address_number,address_complement, address_district, address_city_id, name, freight_rate, kitchen_id, registration_date, update_date, activated) values ("78456000", "Rua José Freire", "123", "Apto. 45", "Centro",3, "Sabor Brasil", 5.00, 1, utc_timestamp,utc_timestamp, true);
insert into restaurant (address_zip_code, address_public_place, address_number,address_complement, address_district, address_city_id, name, freight_rate, kitchen_id, registration_date, update_date, activated) values ("78456000", "Rua José Freire", "123", "Apto. 45", "Centro",3, "Sabor Indiano", 12.00, 3, utc_timestamp,utc_timestamp, true);
insert into restaurant (address_zip_code, address_public_place, address_number,address_complement, address_district, address_city_id, name, freight_rate, kitchen_id, registration_date, update_date, activated) values ("78456000", "Rua José Freire", "123", "Apto. 45", "Centro",2, "La pizza", 8.90, 4, utc_timestamp,utc_timestamp, true);
insert into restaurant (address_zip_code, address_public_place, address_number,address_complement, address_district, address_city_id, name, freight_rate, kitchen_id, registration_date, update_date, activated) values ("78456000", "Rua José Freire", "123", "Apto. 45", "Centro",1, "Tukai Sahismi", 0.00, 2, utc_timestamp, utc_timestamp, true);
insert into restaurant (address_zip_code, address_public_place, address_number,address_complement, address_district, address_city_id, name, freight_rate, kitchen_id, registration_date, update_date, activated) values ("78456000", "Rua José Freire", "123", "Apto. 45", "Centro",2, "Bar da Maria", 6.00, 2, utc_timestamp, utc_timestamp, true);
