...
public class RestaurantProductController {
    ...
    @GetMapping
    public ResponseEntity<List<ProductModel>> findAllByRestaurant(@PathVariable Long restaurantId){
        List<Product> list = productService.findAllByRestaurant(restaurantId);
